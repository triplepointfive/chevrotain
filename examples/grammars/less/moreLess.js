...
const PropertyVariable = createToken({
    ...
    // using "$.color" syntax because "." is a property access in many languages
    // and also because I don't think these kind of variables are ever used in selectors (???)
    // so maybe it won't be confusing with the "." class name selector.
    pattern: /\$\.[\w-]+/
})

// TODO: is this needed or is it identical to PropertyVariable ??
